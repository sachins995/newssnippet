...
<a href= {url} style={{textDecoration:"none"}} target = "_blank" ><div className="card" style={{maxWidth: "325px" ,maxHeight: "410px",overflow:"hidden" }} >
  <img src= {urlToImage?urlToImage:"54323.jpg"} className="card-img-top" alt="..."  style={{height:"182px",width:"324px", objectFit: "contain"}}/>
  <div className="card-body">
    {/* <h5 className="card-title">{title?title+"...":""}</h5> */}
    <h5 className="card-title">{title}</h5>

    {/* <p className="card-text">{description?description+"...":""}</p> */}
    <p className="card-text" style={{color: "palevioletred"}}><small>{(author&&publishedAt)? "Sources: "+author:"Source: Unknown"}</small></p>
    <p className="card-text" style={{color: "lightsteelblue"}}><small>{publishedAt ? "Last Updated: "+new Date(publishedAt).toGMTString():""}</small></p>
